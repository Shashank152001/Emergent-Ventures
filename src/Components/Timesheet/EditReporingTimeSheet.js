...
function EditReporingTimeSheet() {
    ...
    useEffect(()=>{
        if(putTimesheet){
            UpdateReportingTimesheet(formData).then((data)=>{
                console.log(data);
                        ...
                        <form className="mt-4" onSubmit={handleSubmit}>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        value={reportingTimeSheet.hrmid} disabled/>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Name"
                                        value={reportingTimeSheet.name} disabled/>
                                </div>
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Email"
                                        value={reportingTimeSheet.timesheetName} disabled/>
                                </div>
                            </div><div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Role"
                                        value={reportingTimeSheet.clientName} disabled/>
                                </div>
                            </div><div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        ...
                                        value={reportingTimeSheet.projectName} disabled/>
                                </div>
                            </div><div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Leave"
                                        value={reportingTimeSheet.jobName} disabled/>
                                </div>
                            </div><div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        ...
                                        value={reportingTimeSheet.workItem} disabled/>
                                </div>
                            </div><div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="EndDate"
                                        value={reportingTimeSheet.description} disabled/>
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Reason"
                                        value={reportingTimeSheet.date} disabled/>
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Reason"
                                        value={reportingTimeSheet.week} disabled/>
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Reason"
                                        value={reportingTimeSheet.totalTime} disabled/>
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Reason"
                                        value={reportingTimeSheet.billableStatus} disabled/>
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Reason"
                                        value={reportingTimeSheet.submittedHours} disabled/>
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" className="form-control"
                                        placeholder="Reason"
                                        value={reportingTimeSheet.approvedHours} disabled/>
                                </div>
                            </div>
...
export default EditReporingTimeSheet